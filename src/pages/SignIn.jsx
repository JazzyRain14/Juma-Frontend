      ...
      <div className="bg-[#CCCCCC] h-100 min-h-screen  grid grid-flow-row gap-8 p-6 md:grid-cols-grid1 md:gap-4 md:p-8">
        ...
        <div className=" row-span-6">
          ...
          <p className=" font-semibold text-[16px] md:text-[12px]">
            <span className=" text-xl text-projectRed md:text-lg">Sign In</span>
          ...
          <form action="" className="mt-3" onSubmit={formik.handleSubmit}>
            <div className="mt-2 mb-4 md:mt-1 md:mb-3">
              ...
              {formik.touched.email ? (
                <small className="text-projectRed  text-lg md:text-[16px]">
                  {formik.errors.email}
                </small>
              ) : (
                ""
            ...
            <div className="mt-2 mb-4 md:mt-1 md:mb-3">
              ...
              <div
                className={`border p-4 rounded flex items-center bg-[#ffffff] md:p-2 
                            ${
              ...
              >
                ...
                {formik.values.password === "" ? (
                  ...
                  <i
                    onClick={reveal}
                    className="rounded-[50%] flex items-center justify-center w-[30px] h-[100%] cursor-pointer text-[25px] md:text-[20px]"
                  >
                    {eye}
                  </i>
                )}
          ...
          <p className=" text-xl md:text-sm">
            ...
            <Link to="/signup" className="text-[#FF0000] font-medium">
              Sign Up for free
            </Link>
          </p>
        </div>
