...
const SignIn = () => {
    ...
    return (
        ...
        //     className="block p-4
            ...
            className='bg-[#CCCCCC] p-3 grid grid-rows-gridRow1'
        style={{ border:""}}
        >
            {/* left div */}
            <div className='py-4 mb-5 h-fit sm:flex flex-col border'
            >

                {/* logo */}
                <div className=' flex items-center p-2 pl-6 w-full'>
            ...
            {/* right div */}
            <div className=' bg-[#ffffff] min-h-screen p-8 rounded-2xl col-span-1'>

                <h1 className=' m-0 text-3xl sm:text-2xl sm:ml-5'> Welcome Back
                </h1>
                <p className='m-0 text-xs font-semibold sm:ml-5 sm:text-xs'>Let's satisfy your cravings <span></span></p>
