...
const SoftDrksUploadPg = () => {
  ...
  const [isLoading, setIsLoading] = useState(false); // Optional for asynchronous data fetching
  ...
  // const data = {
  //   snacks: [
  //     { Name: 'Chips', Brand: 'Lay\'s', Category: 'snacks', Price: '1500' },
  //     { Name: 'Snacks', Brand: 'Oreos', Category: 'snacks', Price: '3500' },
  //     { Name: 'Chips', Brand: 'Lay\'s', Category: 'snacks', Price: '1500' },
  //     { Name: 'Snacks', Brand: 'Oreos', Category: 'snacks', Price: '3500' },
  //   ],
  //   sweet: [
  //     { Name: 'pongilah', Brand: 'Lay\'s', Category: 'snacks', Price: '1500' },
  //     { Name: 'lollipop', Brand: 'Oreos', Category: 'snacks', Price: '3500' },
  //   ]
  // }
  // const handleSelectedCategory = (newData) => {
