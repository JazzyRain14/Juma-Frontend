  ...
  return (
    <>
      ...
      <div className='flex gap-4 justify-between w-full'>
        <AdminSideBar />
        <div className={`w-full overflow-hidden h-screen rounded-md sm:ml-0 max-sm:ml-0 lg:ml-[300px] flex flex-col transition-all duration-300 ease-in-out 
    ${isOpen ? 'sm:translate-x-[300px] max-sm:translate-x-[300px]' : 'sm:ml-0 max-sm:ml-0'}`}>
          <div className='border py-4 px-4 h-[25%]'>
            <AdminTopNav />
            <h2 className='text-center mt-z5 text-5xl font-semibold sm:text-2xl transition-all duration-200 ease-out max-sm:text-2xl'>Add New Sauces & Condiments Product</h2>
