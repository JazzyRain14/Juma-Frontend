    ...
    if (isOnline) {
      toast.custom((t) => (
        <div className="border p-4 bg-[#ECFDF3] relative">
          <div className=" flex gap-2 items-center">
            ...
            <h1 className="text-lg text-[#008A2E] font-semibold">
              You're Connected
            </h1>
          </div>
          <p className="text-sm text-[#008A2E]">
      ...
      toast.custom((t) => (
        <div className="border p-4 bg-[#FFF0F0] relative">
          ...
          <p className="text-sm text-projectRed-2">
            Looks like you should connect to the internet.
          </p>
          {/* <button className='abso' onClick={() => toast.dismiss(t)}><FaTimes/></button> */}
        </div>
      ));
      ...
      <div className="bg-[#CCCCCC] h-100 min-h-screen grid grid-flow-row gap-8 p-6 md:grid-cols-grid1 md:gap-4 md:p-8">
        ...
        <div className=" row-span-1">
          ...
          <div className="hidden md:flex flex-col gap-[35px] justify-center items-center">
            ...
            <span className="text-[14px]  lg:w-[450px]">
              Welcome To <span className="text-[#FF0000]">Juma</span> Food and
              Confectionaries, We satisfy your cravings. Be Sure to check out on
              our <Link>Terms and Conditions</Link>.
            </span>
          </div>
        </div>
        ...
        <div className=" row-span-6">
          ...
          <h1 className="text-4xl md:text-2xl">
            Welcome to <span className=" text-projectRed">Juma</span>
          </h1>
          <p className=" font-semibold text-[16px] md:text-[12px]">
            <span className=" text-xl text-projectRed md:text-lg">Sign Up</span>
            , Let's satisfy your cravings
          </p>
          <form action="" className="mt-3" onSubmit={formik.handleSubmit}>
            <div className="mt-2 mb-4 md:mt-1 md:mb-3">
              <label className=" block mb-2 text-[#424242] text-[26px] md:text-[15px]">
                Username
              </label>
              <div
              ...
              {formik.touched.username ? (
                <small className="text-projectRed-1  text-lg md:text-[16px]">
                  {formik.errors.username}
                </small>
              ) : (
                ""
            ...
            <div className="mt-2 mb-4 md:mt-1 md:mb-3">
              ...
              <div
                className={`border border-projectBorder p-4 rounded  flex items-center bg-[#ffffff] md:p-2 
                            ${
            ...
            <button
              disabled={
                !!formik.errors.email || !!formik.errors.password || isDisabled
              }
              type="submit"
            ...
            <button className=" w-[100%] p-5 mt-2 mb-4 text-2xl font-semibold border border-projectBlack  text-projectBlack rounded flex justify-center items-center hover:bg-[#f8f8f8] md:p-3 md:mb-3 md:mt-1 md:text-lg">
              <span>
                <img src={google} alt="" className="mr-2 w-5 md:w-7" />
              </span>
          ...
          <p className="text-xl md:text-sm">
            ...
            <Link to="/signin" className="text-[#FF0000] font-medium">
              Sign In
            </Link>
          </p>
        </div>
