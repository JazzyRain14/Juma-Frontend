...
const NavBar = () => {
    ...
    return (
        <>
            <section className={`z-50 w-full fixed top-0 shadow-xl flex items-center transition-colors ease-in-out duration-300 border
                ...
                <div
                    className='flex flex-1 justify-around h-20  items-center lg:static'
                >
                    {/* Links */}
                    <div className=' max-sm:hidden sm:hidden border lg:flex'>
                        <Link to='home'
