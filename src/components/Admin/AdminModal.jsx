...
const EditProductModal = ({ editProduct, itemData, handleProductName, setHandleProductName, handleProductDesc, setHandleProductDesc, handleProductCategory, setHandleProductCategory, handleProductImage, setProductImage, handleProductPrice, setHandleProductPrice, updateProduct }) => {
    ...
    return (
        <>
            <div className='w-full h-full top-0 right-0 bottom-0 fixed'>
                ...
                <div className='absolute top-[50%] left-[50%] -translate-x-2/4 -translate-y-2/4 p-4 max-w-3xl max-md:max-w-xl max-sm:max-w-[20rem] transition-all duration-200 ease-out w-full bg-[#f1f1f1]'>
