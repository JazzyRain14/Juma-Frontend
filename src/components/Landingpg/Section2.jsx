            ...
            <div className=' border rounded-t-[25%] h-[300px] w-full bg-white relative flex flex-col items-center justify-center'>
                <div className='absolute -top-14'>
                    <div>
                        <table>
                            <tbody>
                                <tr className='flex gap-6 px-12'>
                                    {Imgimport.map((images, index) => (
                                        
                                        <li className=' bg-transparent w-36 h-36 rounded-full list-none flex justify-center items-center overflow-hidden cursor-pointer hover:bg-white transition-colors duration-200'>
                                    ...
                                    {/* <li className='border bg-white rounded-full list-none p-2'>
                                <img src={Imgimport.nuggets} alt="" width={150} />
                            </li> */}
                                    {/* <li className='border bg-white rounded-full list-none p-2'>
                                <img src={Imgimport.burgerDish} alt="" width={150} />
                            </li> */}
                                </tr>
                            </tbody>
                        </table>
