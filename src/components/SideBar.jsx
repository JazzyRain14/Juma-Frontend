...
const SideBar = () => {
    ...
    const stylesSideBar = `fixed top-0 flex flex-col sideBarScroll h-full  border-r shadow sm:w-0 max-sm:w-0 lg:w-[300px] transition-all duration-300 ease-in-out ${isOpen ? 'sm:w-[300px] max-sm:w-[300px]' : 'sm:w-0 max-sm:w-0'}`
    return (
        <>
            <section
