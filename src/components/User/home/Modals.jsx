    ...
    <div className="w-full h-full top-0 left-0 right-0 bottom-0 fixed">
      ...
      <div className="absolute top-[40%] left-[50%] -translate-x-2/4 -translate-y-2/4 bg-[#f1f1f1] p-4 max-w-[500px] w-full">
        ...
        <input
          ...
          type="email"
        />
        <button className="block outline-none p-2 border bg-projectRed-2 text-white rounded w-full mb-4">
          Submit
        </button>
      </div>
    </div>
    ...
    <div className="w-full h-full top-0 left-0 right-0 bottom-0 fixed">
      <div
        ...
        className="w-full h-full top-0 left-0 right-0 bottom-0 fixed 
                bg-[rgba(49,49,49,0.8)]"
      ></div>
      <div className="absolute top-[40%] left-[50%] -translate-x-2/4 -translate-y-2/4 p-4 max-w-[500px] w-full  bg-[#f1f1f1]">
        <div className="flex items-center justify-between">
    ...
    <section className=" h-full w-full fixed top-0 left-0 flex z-30 justify-center items-center">
      <div
        className="w-full h-full top-0 left-0 right-0 
                bottom-0 fixed bg-[rgba(49,49,49,0.8)]"
      ></div>
      <div
  ...
  return (
    <section className=" h-full w-full fixed top-0 left-0 flex z-30 justify-center items-center">
      ...
      <div
        className="absolute top-[50%] left-[50%]
         -translate-x-2/4 -translate-y-2/4 transition-all
         duration-200 ease-out rounded-lg border border-black/50 p-4 overflow-hidden bg-white/5"
      >
        ...
        <div className="flex justify-between mt-8">
          <button
            ...
            className="py-2 px-8 text-lg font-medium text-white rounded-lg mx-2 bg-projectBlack"
          >
            Yes
          </button>
          <button
            onClick={CheckOut}
            className="py-2 px-8 text-lg font-medium text-white rounded-lg mx-2 bg-projectRed-2"
          >
            No
          </button>
        </div>
...
export { EditUserModal, CheckOutModal, EditUserPhotoModal, LoadingScreen };
