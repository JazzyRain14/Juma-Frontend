        ...
        <CartProvider>
          <Routes>
            ...
            <Route
              ...
              element={<SaucesUploadPg />}
            />
            <Route
              path="/adminhome/ethnicfood"
              element={<EthnicFoodUploadPg />}
            />
            <Route
              path="/adminhome/bakeryitems"
              element={<BakeryItmUploadPg />}
            />
            <Route
              path="/adminhome/softdrinks"
              element={<SoftDrksUploadPg />}
            />
            <Route
              path="/adminhome/alcoholicbeverages"
              element={<AlcoholicBevUploadPg />}
            />
            <Route
              path="/adminhome/desertandsweets"
              element={<DesertSwtUploadPg />}
            />
            <Route path="home" element={<SharedLayouts />}>
              ...
              <Route
                path=":itemCategory/:item_id"
                element={<ProductDetailspg />}
              />
              <Route path="help&support" element={<HelpSupport />} />
              <Route path="juma wallet" element={<Wallet />} />
              <Route
                path="transanction history"
                element={<TransanctionHistory />}
              />
            </Route>
          </Routes>
        </CartProvider>
